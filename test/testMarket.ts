...
console.log(orderValidator.validateOrder(wrongOrder1));
console.log(orderValidator.validateOrder(wrongOrder2));
console.log(orderValidator.validateOrder(wrongOrder3));
...
matchEngine.handleNewOrder(marketOrder1);
